...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPostion) {
        ...
        ChessPiece movePice = (ChessPiece) board.piece(target);
        //Specialmove promotion
        promoted = null;
        if (movePice instanceof Pawn) {
            if ((movePice.getColor() == Color.WHITE && target.getRow() == 0) || (movePice.getColor() == Color.BLACK && target.getRow() == 7)) {
        ...
        if (movePice instanceof Pawn && (target.getRow() == source.getRow() - 2 || target.getRow() == source.getRow() + 2)) {
            enPassantVulnerable = movePice;
        } else {
    ...
    private void validateSourcePosition(Position position) {
        ...
        if (currentPlayer != ((ChessPiece) board.piece(position)).getColor()) {
            throw new ChessException("The chosen piecce is not yours");
        }
